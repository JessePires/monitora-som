  ...
  return (
    <Containers.SpectrogramContainer>
      {(containerProps: FormContainerProps): JSX.Element => {
        ...
        return (
          <div className="space-y-6 rounded-xl bg-white shadow-md m-4 z-10 pt-[0.03%]">
            <Progress value={containerProps.actions.progress()} className="rounded-none rounded-t-3xl" />
            <Form {...containerProps.form}>
              <form onSubmit={containerProps.form.handleSubmit(onSubmit)} className="px-4 pb-4 flex flex-col gap-5">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <FormControl>
                              ...
                              >
                                {field.value
                                  ? props.speciesTypes.find(
                                      (speciesType: string): boolean => speciesType === field.value,
                                    )
